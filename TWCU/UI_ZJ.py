...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        self.Shipout.setGeometry(QtCore.QRect(110, 20, 91, 19))
...
class Windows(QtGui.QWidget):
    def __init__( self,ID="", parent = None):
        ...
        self.new.name.setText("<font color=black><font size = 8>%s</font>" % u"TWCU")
        ...
        self.new.Select_PD.addItem("TWCU")

        self.new.Upgrade.setDisabled(1)         #设置升级按钮不可用
        self.new.Modify_IP.setDisabled(1)       #设置修改IP按钮不可用
        self.new.Shipout.setDisabled(1)         #设置出厂设置按钮不可用
