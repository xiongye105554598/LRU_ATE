...
class Button(QtGui.QPushButton):
    ...
    def RightMenuShow(self):
        ...
        self.CWAP = self.contextMenu.addMenu("CWAP")
        self.BI6 = self.CWAP.addAction(u'老化')
        self.BI6.triggered.connect(lambda: self.Production(9))
