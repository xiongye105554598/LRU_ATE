...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        self.Shipout.setGeometry(QtCore.QRect(110, 20, 111, 19))
...
class Windows(QtGui.QWidget):
    def __init__( self,ID="", parent = None):
        ...
        self.new.name.setText("<font color=black><font size = 8>%s</font>" % u"CWSU")
